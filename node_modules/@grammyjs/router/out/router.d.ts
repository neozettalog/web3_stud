import { Composer, Context, Middleware, MiddlewareFn, MiddlewareObj } from "./deps.node.js";
...
export declare class Router<C extends Context> implements MiddlewareObj<C> {
     ...
     */
    constructor(router: (ctx: C) => MaybePromise<string | undefined>, routeHandlers?: Record<string, Middleware<C>> | Map<string, Middleware<C>>);
    /**
     ...
     */
    route(route: string, ...middleware: Array<Middleware<C>>): Composer<C>;
    /**
